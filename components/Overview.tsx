                  ...
                  <div className="divide-y divide-gray-50">
                     {lastTransactions.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-gray-500 flex flex-col items-center">
                           ...
                           <p className="font-medium text-gray-600">Nenhuma transação recente</p>
                           <p className="text-xs text-gray-400 mt-1 mb-4">Adicione suas despesas para começar.</p>
                           <button
                              onClick={() => setIsCreateTransOpen(true)}
                              className="text-xs font-bold text-primary-mid hover:underline"
                           >
                              Criar Transação Manually
                           </button>
                        </div>
                     )}
                  </div>
               ...
               <section className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                     {lastTasks.length > 0 ? (
                        ...
                        <div className="col-span-full py-10 flex flex-col items-center justify-center text-center border-2 border-dashed border-gray-100 rounded-3xl">
                           <CheckCircle size={32} className="text-gray-200 mb-2" />
                           <p className="text-sm font-bold text-gray-500">Tudo feito por aqui!</p>
                           <p className="text-xs text-gray-400 mb-4">Adicione novas tarefas para se organizar.</p>
                           <button
                              onClick={() => setIsCreateTaskOpen(true)}
                              className="px-4 py-2 bg-gray-50 text-gray-600 rounded-lg text-xs font-bold hover:bg-gray-100 transition-colors"
                           >
                              Criar Tarefa
                           </button>
                        </div>
               ...
               <section>
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-4 snap-x no-scrollbar">
                     {activeGoals.length > 0 ? (
                        ...
                        <div className="w-full flex flex-col items-center justify-center py-6 bg-white rounded-2xl border border-gray-100 border-dashed">
                           <Target size={24} className="text-gray-300 mb-2" />
                           <p className="text-sm font-bold text-gray-500">Nenhum objetivo ativo</p>
                           <button
                              onClick={() => setIsCreateGoalOpen(true)}
                              className="mt-3 px-4 py-2 bg-pink-50 text-primary-start rounded-xl text-xs font-bold hover:bg-pink-100 transition-colors"
                           >
                              + Criar Objetivo
                           </button>
                        </div>
